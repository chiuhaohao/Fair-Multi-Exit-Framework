...
class ISIC2019:
    def __init__(self, args, batch_size=64, add_trigger=False, model_name=None, feature_dict=None, input_size=128):
        ...
        train_transform = ISIC2019_Augmentations(is_training=True, image_size=self.image_size, input_size=self.image_size, model_name=model_name).transforms
        test_transform = ISIC2019_Augmentations(is_training=False, image_size=self.image_size, input_size=self.image_size, model_name=model_name).transforms
...
class fitzpatrick17k:
    def __init__(self, args, batch_size=64, add_trigger=False, model_name=None, input_size=128):
        self.batch_size = batch_size
